...
class Enemy {
    ...
    update() {
        ...
        this.x = canvas.width / 2 * Math.sin(this.angle * Math.PI / 250) + (canvas.width / 2 - this.width / 2);
        this.y = canvas.height / 2 * Math.cos(this.angle * Math.PI / 250) + (canvas.width / 2 - this.width / 2);
