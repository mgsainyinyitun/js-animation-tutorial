...
document.addEventListener('DOMContentLoaded', function () {
    ...
    class Game {
        ...
        update(deltaTime) {
            this.enemies = this.enemies.filter(obj => !obj.markedForDeleteion);
    ...
    class Enemy {
        ...
        update(deltaTime) {
            ...
            if(this.frameTimer > this.frameInterval){
                if(this.framX < this.maxFrame) this.framX++;
                else this.framX = 0;
                this.frameTimer = 0;
            }else{
    ...
    class Spider extends Enemy {
        ...
        update(deltaTime){
            if(this.y < 0 - this.height * 2) this.markedForDeleteion = true;
            super.update(deltaTime);
